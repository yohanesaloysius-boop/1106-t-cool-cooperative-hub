    ...
    <header className="sticky top-4 z-40 px-3 md:px-6">
      ...
      >
        <Link to="/" className="group flex items-center gap-2.5">
          ...
          >
            {logo.url ? <img src={logo.url} alt="Logo koperasi" className={cn("h-full w-full rounded-full", logo.fit === "cover" ? "object-cover" : "object-contain", logo.bg === "white" && "bg-white")} /> : <Sprout className="h-5 w-5" />}
          </span>
          ...
          <div>
            <div className="flex items-center gap-2.5">
              <span
                ...
                style={{ background: "var(--gradient-primary)" }}
              >
                {logo.url ? <img src={logo.url} alt="Logo koperasi" className={cn("h-full w-full rounded-full", logo.fit === "cover" ? "object-cover" : "object-contain", logo.bg === "white" && "bg-white")} /> : <Sprout className="h-4 w-4" />}
              </span>
